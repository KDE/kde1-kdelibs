...
function (install_icon icon targetdir)
    ...
    if(EXISTS "${icon}.gif")
        install(FILES ${icon}.gif DESTINATION ${KDE1_ICONDIR}/${targetdir} RENAME ${icon}.gif)
    endif()
    if(EXISTS "mini-${icon}.gif")
        install(FILES mini-${icon}.gif DESTINATION ${KDE1_MINIDIR}/${targetdir} RENAME ${icon}.gif)
    endif()
    if(EXISTS "large-${icon}.gif")
        install(FILES large-${icon}.gif DESTINATION ${KDE1_ICONDIR}/${targetdir} large/ RENAME ${icon}.gif)
    endif()
endfunction ()
